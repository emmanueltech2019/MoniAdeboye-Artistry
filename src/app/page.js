      ...
      <div>
        ...
        <div className="h-screen w-full relative trigger-this">
            ...
            <GlobalContainer className={'w-full h-full flex flex-col md:gap-0 gap-3 relative justify-end py-10'} style={{color:"#d0813c"}} >
                <h1 className='md:text-7xl md:text-5xl text-3xl uppercase splitTextChar overflow-hidden font-semibold text-[#C79E7A] hidden md:block' style={{color:"#d0813c"}}>Moni Adeboye Artistry</h1>
                <span className='md:text-7xl text-4xl splitTextWord overflow-hidden hidden md:block' style={{color:"#d0813c"}}>WHERE ARTISTRY. <br /> MEETS ELEGANCE.</span>
