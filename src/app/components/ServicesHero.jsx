    ...
    <>
      ...
      <GlobalContainer className="flex flex-col gap-10 md:w-[80%] mx-auto w-full font-inter">
        <div className='flex flex-col items-center w-full pt-40 pb-20 gap-5'>
          ...
          <p className="font-sans md:px-26 text-center text-[18px]">
            The right beauty experience does more than transform how you look, it refines how you present yourself.
            <br />
            At Moni Adeboye Studio, every service is delivered with precision, intention, and a commitment to refined execution.
            We work with high-performance, professional-grade products to ensure flawless results that photograph beautifully
            and wear seamlessly. Each appointment is designed to be calm, structured, and detail-focused—so you leave polished,
            confident, and impeccably prepared for your moment.
            <br />
            Book your session and experience beauty, executed with intention.
          </p>
        </div>
      </GlobalContainer>

      <Image src={moni} width={1000} height={1000} alt='image' className='w-full object-cover h-150' />
      ...
      <GlobalContainer className="grid md:grid-cols-[4fr_8fr] md:p-20 p-5 mx-auto w-full items-center">
        <div className='flex flex-col items-center w-full pb-20 gap-5'>
          ...
          <p className="text-sm text-black text-center">
            View full bridal packages & pricing
          </p>
        </div>
