...
const Team = () => {
  return (
    <GlobalContainer className='my-20 flex flex-col gap-10'>
        <h4 className='md:text-5xl md:w-1/2 text-3xl'>OUR ARTISTRY EXPERTS</h4>
        <div className="border-t border-[#d8d6d0] py-5">
            <div className="grid md:grid-cols-2">
                ...
                <div className="flex flex-col gap-10">
                    <p>. Artists</p>
                    <p className="text-xl">Our team of skilled artists is dedicated to providing an elevated experience rooted in sophistication and elegance</p>
